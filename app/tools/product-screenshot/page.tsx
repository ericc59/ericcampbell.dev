...
import { ArrowLeft, ChevronLeft, Download, Upload } from "lucide-react";
				...
				<div className="space-y-6">
					...
					<ControlGroup title="Image">
						<div className="flex gap-2">
							...
							{image && (
								<button
									className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-lime-400 text-white rounded-md hover:bg-blue-600"
								...
								<div key={groupName} className="space-y-2">
									...
									<div className="grid grid-cols-6 gap-2">
										{presets.map((preset, index) => (
											<button
												key={index}
												className="w-full aspect-square border rounded-lg hover:ring-2 hover:ring-lime-400 transition-all"
												style={{
