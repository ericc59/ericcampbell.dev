...
export default function MastPage() {
	return (
		<section className="space-y-16">
			...
			<footer className="flex items-center justify-between border-t border-zinc-800/50 pt-8">
				...
				<a
					...
					className="flex items-center gap-2 rounded-lg border border-zinc-800/50 bg-zinc-950/30 px-3 py-2 text-xs text-zinc-400 transition-colors hover:border-zinc-700/50 hover:text-zinc-300"
				>
