...
summary: "The patterns that made the biggest difference in production Next.js apps: eliminating waterfalls, reducing bundle size, and avoiding common RSC mistakes."
---

After shipping Stack0 and Flow Auctions on the App Router, I have opinions about what matters for performance. These are the changes that made a measurable difference.

## Waterfalls Will Kill You

The most common performance mistake is sequential awaits where parallel would work.
