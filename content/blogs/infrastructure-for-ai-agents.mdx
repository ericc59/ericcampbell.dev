...
These are mostly solved problems. GPT-4 and Claude can reason through complex tasks. They can decompose problems into steps. They can call APIs.
...
The agent capabilities are improving fast. Claude and GPT-4 can already handle complex multi-step tasks. Tool use is reliable. Reasoning is getting better.
...
The patterns are still emerging. Best solutions will come from people building real systems.
